...
//  Keychainer_Tests
//
//  Created by lunner on 2021/5/12.
...
class InternetPasswordSpec: QuickSpec {
    override func spec() {
        describe("generic") {
            let server = "www.lunnersword.Keychain.test.com"
            var keychain = Keychain.internet(server: server)
